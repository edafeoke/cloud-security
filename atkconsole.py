...
class atkfltcnsl:
    def show(self, mainfrm):
        ...
        atkflttxtfrm = Frame(atkfltfrm, relief=SOLID,
                             borderwidth=0, bg="white")

        # logo
        atklogo = PhotoImage(file="icon/info.gif")
        logo = Label(atkflttxtfrm, image=atklogo, relief=FLAT,
                     bg="white", width=80, height=80, borderwidth=0)
        logo.photo = atklogo
        ...
        chkrfrm = Frame(chkfrm, relief=SOLID, height=6,
                        borderwidth=0, bg="white")
        ...
        # ---------------------------------------------Block button--------------------------------------------------
        atkfltbtnfrm = Frame(atkfltfrm, relief=SOLID,
                             borderwidth=0, bg="white")
