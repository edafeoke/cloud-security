...
class polfwd:
    def __init__(self, otptpolfrm):
        ...
        title = Label(optitlefrm, text="FORWARD", font=txtfont,
                      relief=FLAT, width=27, height=1)
        ...
        src = Label(oplblfrm, text="Source Address", font=txtfont,
                    relief=RAISED, width=27, height=1)
        src.pack(side=LEFT, anchor=CENTER, pady=0)

        des = Label(oplblfrm, text="Destination Address",
                    font=txtfont, relief=RAISED, width=26, height=1)
        des.pack(side=LEFT, anchor=CENTER, pady=0)

        recv = Label(oplblfrm, text="Protocol", font=txtfont,
                     relief=RAISED, width=16, height=1)
        recv.pack(side=LEFT, anchor=CENTER, pady=0)

        send = Label(oplblfrm, text="Action", font=txtfont,
                     relief=RAISED, width=15, height=1)
        send.pack(side=LEFT, anchor=CENTER, pady=0)

        stt = Label(oplblfrm, text="Miscellaneous", font=txtfont,
                    relief=RAISED, width=33, height=1)
